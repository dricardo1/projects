// v1.7.0,  2012-08-19, copyright Gert-Jan Strik
...
+escape(t.name)+r.substring(i)+'&d2='+parseInt(2E9*Math.random())};function iT(pn,usr,to){var x,a,b,cu,h,o,l,ls,g,z,p,u,t,r=iHOST
+'t.asp?pn='+pn+'&user='+escape(usr)+'&to='+to;u='undefined';a=(typeof iMODE==u?0:iMODE);
z=window.location.href;if(io(z,'http://')==0)z=ss(z,7,z.length);if(io(z,'https://')==0)z=ss(z,8,z.length);var q=io(z,'/');h=''
if(q>0){h=ss(z,0,q);z=ss(z,q+1,z.length)};ls=iTN('link');if(ls)for(i=0;i<ls.length;i++){l=ls[i]
if(l.getAttribute('rel')=='canonical'){cu=l.getAttribute('href');if(cu&&cu!='')z=cu.replace(/^https?:\/\/[^\/]*\//i,'')
